...
<html lang="en">
  <head>
    ...
    <title>GMO Project - Bio 102</title>
    <!-- Bootstrap -->
...
<div class="container mt-0">
  <div class="row">
        <div class="col-16">
          <div class="jumbotron">
		    <h1 class="text-center"><mark>Spicy Tomatoes</mark></h1>
			  <h2 class="text-center">&nbsp;<mark>A New Frontier for Food</mark></h2>     
<img src="../../../Downloads/pexels-karolina-grabowska-4020637.jpg" alt="" width="1200" height="806" class="img-fluid rounded">

<h5 class="text-left">Scientists are&nbsp; trying to activate the capsaicinoid biosynthetic pathway in tomato plants. Most hybrid species of peppers have been created through selective breeding and hybridization. To make a spicy tomato, scientists would have to activate the capsaicin pathway that is already in tomatoes. Current research revolves around using CRISPR gene editing to allow for the activation of this pathway.</h5>
<figure>Photo by Karolina Grabowska:
  <figcaption>https://www.pexels.com/photo/assortment-of-fresh-vegetables-with-lemon-in-food-net-4020637/</figcaption>
</figure> 
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center col-md-6 col-12">
          <h3>Solanaceae</h3>
          <p align ="left">Tomatoes and peppers come from the same family of flowering plans called Solanaceae. <strong>This relationship may be why the capsaicin pathway already exists in tomatoes.&nbsp;</strong> &nbsp;</p>
	    <img src="Solanums_in_a_box.jpg" alt="" width="672" height="378" class="img-fluid"/> 
		 <figure align="left"><a href="https://www.wikiwand.com/en/Solanaceae"><em>Source</em></a></figure> 
	    </div>
        <div class="text-center col-md-6 col-12">
          <h3>Capsaicin</h3>
          <p class="text-left">Capsaicin is the chemical in chili peppers that give them their spiciness. It is an alkaloid that helps protect them from fungus and mammals. Capsaicin has shown several health benefits as well as interest from the culinary desires for new foods and flavors.</p>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Ub4OFs4YIY8?start=221&end=355" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <div class="container mt-4">
      <div class="row">
          <div class="card">
            <img class="card-img-top img-fluid" src="Capsaicin Pathway.png" alt="capsacin-pathway" width="600" height="377">
            <div class="card-body">
  ...
  <div class="container">
      <div class="row">
        ...
        <img src="toxicity-graphic-edit.jpg" alt="" width="1433" height="854" class="img-fluid rounded"/>
...
Megan L. Norris is a Ph.D. candidate in t he Molecular, Cellular and Organismal Biology Program at Harvard University</p>
    ...
    <div class="container">
		...
		<h3> References</h3>
			...
			<li><a href="https://www.cell.com/trends/plant-science/fulltext/S1360-1385(18)30261-9#%20">Capsaicinoids: Pungency beyond Capsicum</a></li>
